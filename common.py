...
class ConfigRandLA3D:
    k_n = 16  # KNN
    num_layers = 4  # Number of layers
    num_points = 8192  # Number of input points
    feature_dim = 128  # Number of valid classes
    sub_grid_size = 0.06  # preprocess_parameter
    model_path = 'datasets/ycb/YCB_Video_Dataset/'
    batch_size = 3  # batch_size during training
    val_batch_size = 3  # batch_size during validation and test
    #train_steps = 500  # Number of steps per epochs
    #val_steps = 100  # Number of validation steps per epoch
