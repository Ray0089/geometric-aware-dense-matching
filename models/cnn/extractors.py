...
from config.lmo_cfg import MODEL

model_save_dir = MODEL['resnet_dir']      
...
def resnet18(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet18'], model_dir=model_save_dir
            )
        )
    return model
...
def resnet34(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet34'], model_dir=model_save_dir
            )
        )
    return model
...
def resnet50(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet50'], model_dir=model_save_dir
            )
        )
    return model
...
def resnet101(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet101'], model_dir=model_save_dir
            )
        )
    return model
...
def resnet152(pretrained=False):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            model_zoo.load_url(
                model_urls['resnet152'], model_dir=model_save_dir
            )
        )
    return model
